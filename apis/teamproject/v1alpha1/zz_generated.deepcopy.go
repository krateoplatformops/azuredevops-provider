...
func (in *Capabilities) DeepCopyInto(out *Capabilities) {
	*out = *in
	out.Versioncontrol = in.Versioncontrol
	out.ProcessTemplate = in.ProcessTemplate
}
...
func (in *TeamProjectStatus) DeepCopyInto(out *TeamProjectStatus) {
	*out = *in
	...
	if in.OperationReference != nil {
		in, out := &in.OperationReference, &out.OperationReference
		*out = new(OperationReference)
		(*in).DeepCopyInto(*out)
	}
}

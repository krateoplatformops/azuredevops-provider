...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserResource) DeepCopyInto(out *UserResource) {
	*out = *in
	if in.Type != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserResource.
func (in *UserResource) DeepCopy() *UserResource {
	if in == nil {
		return nil
	}
	out := new(UserResource)
